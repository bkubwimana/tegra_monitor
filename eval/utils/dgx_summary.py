"""
DGX-specific summary handler that extends the base Summary class
...
class DGXSummary(Summary):
    """Extended summary class for DGX evaluations with GPU and performance metrics"""
    ...
    def save(self, output_file_path):
        ...
        with open(summary_file, 'w') as f:
            f.write(f"DGX Evaluation Summary - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
            f.write("=" * 60 + "\n\n")
        ...
        print(f"DGX summary saved to: {summary_file}")
